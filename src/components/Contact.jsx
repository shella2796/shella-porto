...
const contactLinks = [
  ...
  { label: "GitHub", url: "https://github.com/shella2796", icon: BsGithub },
];
    ...
    <section id="contact" className="flex min-h-[75vh] scroll-mt-20 items-center border-t border-white/10 bg-[#050507] py-24 sm:py-28 lg:py-[120px]">
      ...
      >
        ...
        <h2 className="mx-auto max-w-[950px] font-serif-display text-[clamp(3.3rem,8vw,7.8rem)] font-normal leading-[0.92] tracking-[-0.04em]">
          Let’s bring clarity to your next project.
        </h2>
        <p className="mx-auto mt-8 max-w-xl text-base leading-8 text-[#9d98a3]">
          If your team needs stronger coordination, clearer documentation, or more consistent stakeholder communication, I’d be happy to discuss how I can help.
        </p>
        <motion.a
          href="mailto:shellawaramena@gmail.com"
          className="mt-10 inline-block border-b border-[#b04d6b] font-serif-display text-[clamp(1.35rem,4vw,3.3rem)] transition-colors hover:text-[#b04d6b]"
          whileHover={{ y: -2 }}
        >
        ...
        <div className="mt-9 flex items-center justify-center gap-3">
          {contactLinks.map(({ label, url, icon: Icon }) => (
            <motion.a
              key={label}
              href={url}
